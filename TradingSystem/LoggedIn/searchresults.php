...
<body>
    ...
    <div class="card-container" style="position: absolute; top: 30px;">
        <?php include 'getsearchresults.php'; ?>
            ...
            <?php foreach ($searchResults as $result) : ?>
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <?php if($personalInsertions){ ?>
                            <a href="delete_insertion.php?ID=<?= $result[2] ?>" class="btn" style="margin-left: 5px; width: 112px;">Elimina</a>
                        <?php
                        }
                        ?>
                    </div>
